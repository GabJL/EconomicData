...
"""
    ...
    DPX1 crossover
    mutation described in correction "C" : replace the mutated cluster by a random cluster based on a probability correlated to the distance between the sample represented by the gene and the cluster chosen
...
def cGA1(pop,dim,it,pc,pm,data_clust,k,N,D):  
    """
