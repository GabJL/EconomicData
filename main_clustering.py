...
num_elbows = 3
num_features = 4
# lb_distance represents the distance to consider in order to decide if two series are similar NB: the distance is
# set enough large so that all the pairs of series are considered similar and are processed to extract the list of
# series to be maintained during 4th step.
