...
print("  - The 10 first values are the results of the clustering (i.e. dispersion) using 1 .. 10 clusters.")
...
print('- At the end of execution, the ideal number of clusters to be used for the clustering (i.e. Medians of all the '
      'elbows).')
print("***********************************************************************************************")
...
for tuple1 in data_ser:
    ...
    for centro in range(10):
        ...
        clust = KMeans(n_clusters=centro + 1, init='k-means++', n_init=10, max_iter=300, tol=0.0001, verbose=0,
    ...
    print(
        displayed_data)  # print the clustering data (1x11 array: 10 dispertion values of clustering + value of the elbow)
