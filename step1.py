# -*- coding: utf-8 -*-
"""
Created on Thu Jul 23 16:31:31 2020
"""
...
def clustering_step_1(verb):
    ...
    if verb == 1:
        ...
        print("  - At the end of execution, the ideal number of clusters to be used for the clustering (i.e. Medians of all the elbows).")  
        print("***********************************************************************************************")  
    ...
    for tuple1 in data_ser:
        ...
        displayed_data = []; # it is the 1x11 values array that contains the value of dispertion when applying cluseting using 1 .. 10 clusters and the 11th value is the value of the elbow
        ...
        dispertion = []; # contains the dispertion value after applying each clustering: will be used for computing the elbow
        ...
        for centro in range(10):
            ...
            clust = KMeans(n_clusters=centro+1, init= 'k-means++',  n_init=10, max_iter=300, tol=0.0001, verbose=0,random_state=None,copy_x=True, algorithm='auto').fit(data_all)
        ...
        if verb == 1:      
            print(displayed_data) # print the clustering data (1x11 array: 10 dispertion values of clustering + value of the elbow)
    if verb == 1:
        print("***********************************************************************************************")
        print("Ideal # of clusters to be used for the clustering (Median of elbows) is %i: " % statistics.median(stored_elbows))  
        print("***********************************************************************************************")
    print("***********************************************************************************************")
